// Trello SDK dynamisch laden
function loadTrelloSDK() {
  return new Promise((resolve, reject) => {
    ...
    script.onload = () => resolve(window.TrelloPowerUp);
    script.onerror = () => reject(new Error('Failed to load Trello SDK'));
...
async function initApp() {
  try {
    ...
    console.error('Failed to initialize Trello Power-Up:', error);
  }
}
